...
public class SolarInfoTodayTinyProvider extends AppWidgetProvider {
    ...
    public static void updateWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivities(context, MainActivity.getRequestCodeForOpeningRegion(region), new Intent[]{intentForClick}, PendingIntent.FLAG_IMMUTABLE);
