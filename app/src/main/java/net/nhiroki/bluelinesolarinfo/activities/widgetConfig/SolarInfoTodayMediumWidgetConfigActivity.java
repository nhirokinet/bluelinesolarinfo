...
public class SolarInfoTodayMediumWidgetConfigActivity extends AppCompatActivity {
    ...
    protected void onCreate(android.os.Bundle savedInstanceState) {
        ...
        findViewById(R.id.config_widget_solar_info_today_change_region_button).setOnClickListener(view -> {
            ...
            List<RegionOnTheEarth> regionOnTheEarthList = DataStore.getInstance(SolarInfoTodayMediumWidgetConfigActivity.this.getApplicationContext()).getRegions();
            ...
            builder.setItems(items, (dialogInterface, i) -> {
                SolarInfoTodayMediumWidgetConfigActivity.this.selectedRegion = regionOnTheEarthList.get(i);
                SolarInfoTodayMediumWidgetConfigActivity.this.refreshDisplay();
            });
            builder.create().show();
        });
        ...
        findViewById(R.id.config_widget_solar_info_today_ok_button).setOnClickListener(view -> {
            ...
            AppPreferences.setRegionBasedWidgetConfig(SolarInfoTodayMediumWidgetConfigActivity.this.getApplicationContext(), this.appWidgetId, widgetConfig);
            this.updateWidgets();

            Intent resultValue = new Intent().putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, this.appWidgetId);
            SolarInfoTodayMediumWidgetConfigActivity.this.setResult(RESULT_OK, resultValue);
            SolarInfoTodayMediumWidgetConfigActivity.this.finish();
        });
    ...
    private void updateWidgets() {
        WidgetUpdateWorker.updateAllWidgets(this.getApplicationContext());
    }
}
